...
const originalCalendarEvents = [
  ...
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2024, 7, 11, 12, 0),
    end: new Date(2024, 7, 11, 12, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2024, 7, 11, 13, 0),
    end: new Date(2024, 7, 11, 13, 45),
  },
  {
    title: "English",
    allDay: false,
...

  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2024, 7, 13, 12, 0),
    end: new Date(2024, 7, 13, 12, 45),
  },
  {
    title: "History",
    allDay: false,
  ...
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2024, 7, 15, 7, 0),
    end: new Date(2024, 7, 15, 7, 45),
  },
  {
    title: "English",
    allDay: false,
  ...
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2024, 7, 15, 12, 0),
    end: new Date(2024, 7, 15, 12, 45),
  },
  {
    title: "History",
    allDay: false,
...
const mapEventsToCurrentWeek = (
  originalEvents: typeof originalCalendarEvents
) => {
  const today = new Date();
  const dayOfWeek = today.getDay();
  const diff = today.getDate() - dayOfWeek;
  const currentSunday = new Date(today.setDate(diff));
  currentSunday.setHours(0, 0, 0, 0); // تصفير الوقت

  return originalEvents.map((event) => {
    const originalStart = event.start;
    const originalEnd = event.end;
    if (!originalStart || !originalEnd) {
      console.warn(`Event ${event.title} missing start or end date.`);
      return event;
    }
    const originalDayIndex = originalStart.getDay();
    const newStart = new Date(currentSunday);
    newStart.setDate(currentSunday.getDate() + originalDayIndex);
...
export const calendarEvents = mapEventsToCurrentWeek(originalCalendarEvents);
